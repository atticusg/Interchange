...
def analyze_counts(data):
    with torch.no_grad():
        ...
        for i, data_dict in enumerate(data):
            ...
            res = analyze_one_mapping(data_dict, mapping)
...
def analyze_one_mapping(results, mapping):
    """
                         LOW      (base_eq)      HIGH
...
#         a = InterchangeAnalysis(opts["save_path"], None, None, **opts)
#         res_dict = a.analyze()
#         print(res_dict)
#         return res_dict
#
